...
void SimpleStreamChecker::checkPostCall(const CallEvent &Call,
    ...
    if (Call.getCalleeIdentifier() != IIfopen) return;
...
void SimpleStreamChecker::checkPreCall(const CallEvent &Call,
    ...
    if (Call.getCalleeIdentifier() != IIfclose) return;
...
void SimpleStreamChecker::reportDoubleClose(SymbolRef FileDescSym,
    ...
    // Generate the report.
    BugReport *R =
        new BugReport(*DoubleCloseBugType,
...
bool SimpleStreamChecker::guaranteedNotToCloseFile(
    ...
    if (Call.argumentsMayEscape()) return false;
...
ProgramStateRef SimpleStreamChecker::checkPointerEscape(
    ...
    for (InvalidatedSymbols::const_iterator I = Escaped.begin(),
        ...
        // The symbol escaped. Optimistically, assume that the corresponding
        // file
